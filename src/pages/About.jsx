  ...
  return (
    <div className="pt-20 md:pt-24">
      <PageHero
        ...
        subtitle="Your premier shopping destination in the heart of Rustenburg Central"
        backgroundImage="assets/hero/clearview-hero-about-groceries-01.jpg"
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            <img
              ...
              alt="Clearview Square Shopping Centre building exterior"
              loading="lazy"
              decoding="async"
              className="rounded-2xl shadow-2xl w-full border border-black/5"
            />
            <div className="bg-black/10 rounded-2xl p-6 border border-black/5">
              ...
              <ul className="space-y-2 text-brand-mid">
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-brand-accentStrong mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="card border border-black/5 hover:shadow-xl transition-shadow">
            ...
            {/* Amenities */}
            <div className="bg-gradient-to-br from-brand-dark to-brand-dark rounded-2xl p-8 text-white border border-black/5 shadow-md">
      ...
      <section className="bg-brand-bg py-16">
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#/stores" className="btn text-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand-dark focus-visible:outline-offset-2">Browse Stores</a>
            <a href="#/contact" className="btn-alt text-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand-dark focus-visible:outline-offset-2">Get in Touch</a>
          </div>
        </div>
      </section>
    </div>
